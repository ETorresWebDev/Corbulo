...
namespace Sabio.Web.Services
{
    public class UserOnboardService : BaseService
    {
        ...
        public static OnboardRegistration Get(int id)
        {
        ...
        private static OnboardRegistration UserMap(IDataReader reader)
        {
        ...
        public static void Update1(UserOnboardUpdate1 model)
        {
        ...
        public static void Update3(UserOnboardUpdate3 model)
        {
        ...
        public static void Update4(UserOnboardUpdate4 model)
        {
        ...
        public static void Update5(UserOnboardUpdate5 model)
        {
